        ...
        <div class="modal-content animated bounceInRight">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select name="cuenta_editar" id="cuenta_editar" class="select2_form form-control"
                                    required>
                                    <option value=""></option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="tipo_documento_editar" id="tipo_documento_editar"
                                    class="form-control" value="RECIBO" readonly>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="monto_editar" name="monto_editar"
                                    required readonly>
                            </div>
                            <div class="form-group">
                                <label class="">Documento</label>
                                <input type="text" name="documento_editar" id="documento_editar"
                                    class="form-control">
                            </div>
                            <div class="form-group">
            ...
            <div class="modal-footer">
                ...
                <div class="col-md-6 text-right">
                    <button type="submit" form="frm_editar_egreso" class="btn btn-primary btn-sm btn-submit-edit"><i
