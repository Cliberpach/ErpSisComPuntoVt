                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group select-required">
                                    ...
                                    <select disabled class="select2_form form-control input-required {{ $errors->has('cliente_id') ? ' is-invalid' : '' }}"
                                    ...
                                    <input type="hidden" value="{{ $documento->cliente_id }}" name="cliente_id">
                                </div>
                                ...
                                <input type="hidden" class="form-control" name="duplicado" value="{{ $documento->id }}">
        ...
        axios.get("{{ route('Caja.movimiento.verificarestado') }}").then((value) => {
            ...
            if (!data.success) {
                ...
                if(envio_ok)
                {
                    ...
                    var url = '{{ route("ventas.documento.storeDuplicado") }}';
