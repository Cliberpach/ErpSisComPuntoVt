            ...
            success: function(data) {
                ...
                if (data.productos.length > 0) {
                    ...
                    for(var i = 0;i < data.productos.length; i++)
                    {
                        ...
                        var newOption = '<option value="'+data.productos[i].id+'" peso="'+data.productos[i].peso_producto+'" unidad="'+data.productos[i].medida_desc+'" descripcion="'+data.productos[i].nombre+'">'+data.productos[i].nombre + codigo + '</option>';
